...
- Expanded workflow documentation in QUICKSTART.md to specify script dependencies and internal calls
...
- Fixed Mermaid diagram in `docs/ARCHITECTURE.md` for GitHub rendering compatibility
